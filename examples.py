...
# Khởi tạo LLM 
# model_llama = ChatOllama(model="Llama3.1", temperature=0.0)
# logger.info("Mô hình Llama3.1 được khởi tạo thành công.")
...
#     max_retries=2,
# )
# logger.info("Mô hình model_gemini được khởi tạo thành công.")
...
# query_generation_chain = QUERY_PROMPT | model_gemini | output_parser

### Đoạn này dùng để test từng function
